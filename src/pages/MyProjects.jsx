...
const MyProjects = () => {
    ...
    useEffect(() => {
        let config = {
            ...
            url: "https://brixon-811bf88a933a.herokuapp.com/api/projects/my-projects?start="+start,
            headers: {
        ...
        axios
            .request(config)
            .then((response) => {
                setProjects(response.data); // Assuming your response is an array of projects
            })
            .catch((error) => {
                console.log(error);
            });
    ...
    return (
        <div className={"my-project-container"}>
            ...
            <div className="my-project-main-container">
                <div className="my-project-top-menu">
                    <div className="my-project-search">
                        <input value={start}  onChange={(event) => {
                            const { value } = event.target;  // Get the value from the input
                            setStart(value)
                        }} placeholder={"Search"}/>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                            <g clip-path="url(#clip0_57_656)">
                                <circle cx="9.58317" cy="9.58341" r="7.91667" stroke="#AEAEB2" stroke-width="1.5"/>
                                <path d="M15.4165 15.4167L18.3332 18.3334" stroke="#AEAEB2" stroke-width="1.5" stroke-linecap="round"/>
                            </g>
                            <defs>
                                <clipPath id="clip0_57_656">
            ...
            <div className="my-projects-navigation">
                <div className="my-projects-navigation-container">
                    ...
                    <div className="my-projects-navigation-buttons-pages">
                        ...
                        {projects.length > projectsPerPage && currentPage > 3 && (
